...
export const QuestionsBrowser = ({ isMobile, openSidebar }: Props) => {
  const { filters, setPage } = useFilters();

  const { data, error, isLoading } = useFetchQuestionsQuery({
    specializationSlug: filters.specialization,
    skillsIdx: filters.skills,
